...
The current fully implemented variants as of February 2026 include:
...
The CV demonstrator is built in modular fashion, as shown in Figure 2. While the core processing chain between MIPI camera module and host CPU is always present, equipment of the platforms with interfaces varies such that some variants implement a limited set of the features mentioned next.
