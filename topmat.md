...
|---|---|---|---|---|---|---|---|
|||x|||KB0 Whiznium CV Demonstrator|2026-02-24|demontstrator hardware and paths of exploration|
...
|||x|x||KB8 Microchip PolarFire SoC Variant|2026-02-24|platform-specifics and build instructions for Microchip's MPFS Disco kit|
|x|x||||<div style="color:lightgray">KB9 Whiznium Initialization</div>|TBD|baseline combined with custom / project-specific tool initialization|
...
|x||x|||KB20 Mastering the Job Tree|2026-02-24|key concepts of the run-time job hierarchy including calls and dispatches|
